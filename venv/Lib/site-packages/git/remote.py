...
from .refs import Head, Reference, RemoteReference, SymbolicReference, TagReference
...
class PushInfo(object):
    ...
    def __init__(
        self, flags, local_ref, remote_ref_string, remote, old_commit=None, summary=""
    ):
...
class Remote(LazyMixin, Iterable):
    ...
    def _get_push_info(self, proc, progress):
        ...
        handle_process_output(
            proc, stdout_handler, progress_handler, finalizer=None, decode_streams=False
        )
        stderr_text = progress.error_lines and "\n".join(progress.error_lines) or ""
        try:
            proc.wait(stderr=stderr_text)
